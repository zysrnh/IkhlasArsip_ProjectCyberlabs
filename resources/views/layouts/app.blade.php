            ...
            <div class="py-5 space-y-1">
                ...
                @if(auth()->user()->isSuperAdmin())
                    ...
                    <a 
                        ...
                        class="mx-3 px-3.5 py-2.5 rounded-lg flex items-center space-x-3 text-xs font-semibold transition-colors {{ request()->routeIs('trash.*') ? 'bg-tealBrand text-white shadow-sm' : 'text-slate-300 hover:bg-navy-800 hover:text-white' }}"
                    >
                        <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
