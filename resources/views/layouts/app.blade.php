        ...
        <div class="flex-1 overflow-y-auto py-4 px-3 space-y-5">
            ...
            <div class="space-y-1">
                ...
                <a 
                    ...
                    class="sidebar-nav-item flex items-center space-x-3 px-3 py-2 text-xs font-semibold rounded transition-all duration-150 {{ request()->routeIs('kitchen-reports.*') ? 'bg-tealBrand text-white font-bold' : 'text-slate-300 hover:bg-navy-800 hover:text-white' }}"
                >
                    <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
