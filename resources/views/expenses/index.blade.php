    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        @if(!auth()->user()->isViewer())
            <button 
                ...
                class="px-4 py-2.5 bg-[#0B192C] hover:bg-[#142B4D] text-white text-xs font-bold rounded-xl shadow-sm inline-flex items-center justify-center space-x-2 transition-all duration-150 cursor-pointer self-start sm:self-auto"
            >
