                ...
                <div class="overflow-x-auto max-h-[560px]">
                    <table class="w-full text-left border-collapse text-xs">
                        ...
                        <tbody class="divide-y divide-slate-100 text-slate-800 font-medium" id="dishesTableBody">
                            ...
                            <tr class="hover:bg-slate-50/60 transition item-row" data-index="{{ $index }}" data-name="{{ strtolower($item->menu->name ?? '') }}" data-perishable="{{ ($item->menu && $item->menu->is_perishable) ? '1' : '0' }}">
        ...
        <div id="tabContentSettlement" class="hidden space-y-5">
            <div class="bg-white p-6 rounded-2xl border border-slate-200 shadow-xs space-y-6">
                    ...
                    <div class="bg-slate-50/75 p-4 rounded-xl border border-slate-200 focus-within:border-[#0A97B0] focus-within:bg-white transition">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                name="cash_income" 
                                id="cashIncomeInput" 
                                value="{{ number_format($kitchenReport->cash_income, 0, ',', '.') }}" 
                    ...
                    <div class="bg-slate-50/75 p-4 rounded-xl border border-slate-200 focus-within:border-[#0A97B0] focus-within:bg-white transition">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                name="qris_income" 
                                id="qrisIncomeInput" 
                                value="{{ number_format($kitchenReport->qris_income, 0, ',', '.') }}" 
                                oninput="formatRupiahInput(this); calculateSettlement();" 
                                class="w-full text-base font-extrabold pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-slate-900 focus:outline-none focus:border-tealBrand"
                            >
                        </div>
                    ...
                    <div class="bg-slate-50/75 p-4 rounded-xl border border-slate-200 focus-within:border-[#0A97B0] focus-within:bg-white transition">
                        ...
                        <div class="relative">
                            ...
                            <input 
                                ...
                                value="{{ number_format($kitchenReport->online_food_income, 0, ',', '.') }}" 
                                oninput="formatRupiahInput(this); calculateSettlement();" 
                                class="w-full text-base font-extrabold pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-slate-900 focus:outline-none focus:border-tealBrand"
                            >
                        </div>
                ...
                <div>
                    ...
                    <textarea name="notes" rows="2" class="w-full text-xs border border-slate-200 rounded-xl p-3 bg-slate-50 focus:bg-white focus:outline-none focus:border-tealBrand transition">{{ $kitchenReport->notes }}</textarea>
                </div>
            </div>
