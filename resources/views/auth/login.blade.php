                ...
                <form action="{{ route('login') }}" method="POST" class="space-y-4 sm:space-y-5">
                    ...
                    <div>
                        <div class="flex items-center justify-between mb-1.5">
                            ...
                            <a href="{{ route('password.request') }}" class="text-[11px] font-semibold text-tealBrand hover:text-tealBrand-hover hover:underline transition-colors">
                                Lupa Password?
                            </a>
                        </div>
                        <div class="relative">
                            ...
                            <button 
                                type="button" 
                                id="togglePassword" 
                                class="absolute inset-y-0 right-0 pr-3.5 sm:pr-4 flex items-center text-slate-400 hover:text-slate-700 text-xs font-semibold select-none cursor-pointer"
